...
**آخرین بروزرسانی:** `2026-06-07 21:50:12` (به وقت ایران)
...
> آپدیت:  
> در پیام‌های بعدی روی این تاکید می‌کنند که صدا خیلی طولانی بود و چند دقیقه طول کشید.  
> بعضی‌ها هم نوشتند این بار هم هواپیمای مسافربری بوده با رفتار عجیب.  
> هرچی بوده داخلی بوده. هواگردهای خارجی اول در استان‌های دیگر رصد میشن نه یهو وسط تهران.  
> 📡 @VahidOnline  
