...
**آخرین بروزرسانی:** `2026-06-15 00:45:50` (به وقت ایران)
...
> وال‌استریت ژورنال:  
> ترامپ می‌گوید به زودی بیانیه‌ای صادر خواهد کرد و در آن اعلام خواهد کرد که ایالات متحده با ایران به توافق رسیده است. تهران هنوز وجود چنین توافقی را تأیید نکرده است.  
>  
> ترامپ اظهار داشت: «بعداً مسائل هسته‌ای را حل می‌کنیم» و افزود که «هیچ عجله‌ای نیست» و می‌توان ظرف یک یا دو ماه آینده به آن پرداخت.  
>  
> ترامپ به وال استریت ژورنال: من هرگز به تغییر رژیم در ایران علاقه‌ای نداشته‌ام و در حال حاضر با گروه سوم که منطقی‌ترین هستند، سر و کار داریم.  
>  
> من می‌خواهم به حملات پایان دهم و ایرانی‌ها هم می‌خواهند جنگ را تمام کنند.  
> wsj.com  
>  
> 📡 @VahidOnline  
