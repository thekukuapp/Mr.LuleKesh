...
**آخرین بروزرسانی:** `2026-07-25 20:55:46` (به وقت ایران)
...
>  
> ترجمه ماشین:  
> دونالد ترامپ، رئیس‌جمهوری آمریکا، روز جمعه به ارتش این کشور دستور داد حملات جدیدی در ایران انجام ندهد و به این ترتیب، روند نزدیک به دو هفته حملات روزانه متوقف شد؛ این خبر را دو منبع آگاه از این تصمیم اعلام کردند.  
>  
> چرا مهم است: دستور رئیس‌جمهوری پس از آن صادر شد که او طی ۱۳ روز گذشته، هر روز حملاتی را تأیید کرده بود. مشخص نیست دستور روز جمعه ترامپ تصمیمی یک‌باره بوده یا این وقفه ادامه خواهد یافت.  
>  
> تصمیم ترامپ هم نشان‌دهنده تمایل او به فراهم کردن فضای بیشتر برای دیپلماسی است و هم بیانگر این ارزیابی که ــ در صورت بازنگشتن به عملیات رزمی گسترده ــ سطح کنونی حملات آمریکا به سقف اثربخشی خود رسیده است.  
>  
> اگر ترامپ دستور ازسرگیری حملات را صادر کند، ارتش آمریکا می‌تواند با اطلاع قبلی نسبتاً کوتاهی نیروهای خود را به حرکت درآورد.  
>  
> ارتش آمریکا همچنان در حال آماده‌سازی طرح‌هایی برای بازگشت احتمالی به عملیات رزمی گسترده است، اما به گفته منابع، ترامپ هنوز دستوری برای حرکت در این مسیر صادر نکرده است.  
>  
> کاخ سفید به درخواست برای اظهارنظر پاسخ نداد.  
>  
> تحولات اصلی: در دو هفته گذشته، ترامپ هر روز بعدازظهر طرح‌های حمله ارائه‌شده از سوی ارتش را تأیید می‌کرد و این حملات ظرف چند ساعت اجرا می‌شدند.  
>  
> به گفته منابع، ترامپ روز جمعه نیز طرح مشابهی دریافت کرد، اما چراغ سبز نشان نداد. در عوض، به ارتش دستور داد حمله‌ای انجام ندهد.  
>  
> اندکی پس از صدور این دستور در روز جمعه، ترامپ در کاخ سفید به خبرنگاران گفت که می‌تواند حملات را ادامه دهد یا حتی آن‌ها را تشدید کند؛ از جمله با «نابود کردن هرچه دارند».  
>  
> اما او به‌صراحت گفت که به نظرش «راهبرد هوشمندانه‌تر» این است که با ایران «به توافق برسیم».  
>  
> ترامپ گفت: «همین حالا با [ایرانی‌ها] در حال گفت‌وگو هستیم. فکر می‌کنم هرچه روزها می‌گذرد، جدی‌تر و جدی‌تر می‌شوند. کاملاً مسلح و آماده‌ایم که وارد عمل شویم، اما داریم با آن‌ها گفت‌وگو می‌کنیم.»  
>  
> ترامپ بعدتر در روز جمعه، طی سخنانش در شام انجمن خبرنگاران کاخ سفید گفت تصور نمی‌کند ایران در حال حاضر آماده توافق باشد، «اما من حاضرم گوش بدهم».  
>  
...
>  
> دو منبع منطقه‌ای آگاه از مذاکرات گفتند در گفت‌وگوها پیشرفت‌هایی حاصل شده و ممکن است طی آخر هفته توافقی میان عمان و ایران به دست آید.  
>  
> پس از آن، دونالد ترامپ باید تصمیم بگیرد که آیا توافق پیشنهادی را می‌پذیرد یا نه.  
> axios  
>  
> 📡 @VahidOnline  
