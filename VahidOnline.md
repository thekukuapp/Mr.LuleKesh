...
**آخرین بروزرسانی:** `2026-07-31 21:35:53` (به وقت ایران)
...
> ترامپ: امروز فقط می‌خواهم اشاره کنم که شنیدیم در مینه‌سوتا یک حمله سایبری رخ داده و آن را به ایران نسبت داده‌اند.  
...
> ....  
>  
> ایران اکنون وضعیت بسیار بدی دارد؛ محض اطلاع کسانی که گزارش‌های نادرست می‌خوانند. وضعیتشان بسیار، بسیار بد است. شرایط سختی دارند. در برخورد با ما بسیار دروغگو و بسیار بی‌شرافت بوده‌اند.  
> اما این چیزی را تغییر نمی‌دهد. وضعیتشان بسیار، بسیار بد است.  
>  
>  
...
>  
>  
> ما اینجا کار فوق‌العاده‌ای انجام داده‌ایم. پنج ماه است که وارد این عملیات شده‌ایم. می‌دانم مردم چه می‌گویند، چون این مأموریت بسیار بزرگ‌تر و مهم‌تر از چیزی شده که ابتدا انتظار داشتیم.  
>  
...
> اگر می‌خواهید کمی درباره‌اش بدانید، جک اسمیت قبلاً آنجا کار می‌کرد. این‌ها کسانی هستند که فکر می‌کنند می‌توانند هر رهبر جهان را تحت پیگرد قرار دهند و به لاهه بکشانند.  
> ما ابتدا تلاش کردیم آن‌ها را به اصلاح وادار کنیم و از آن‌ها خواستیم به حرف ما گوش دهند. این کار را نکردند؛ بسیار متکبر هستند. اکنون تلاشی را آغاز کرده‌ایم تا واقعاً آن دادگاه را مهار کنیم.  
> ترامپ: هیچ اطلاعاتی وجود ندارد که نشان دهد آن‌ها دنبال من هستند. البته ممکن است چنین اتفاقی بیفتد.  
> فقط بدانید، او درباره این موضوع صحبت می‌کند. حرف من این است که این یعنی او نمی‌خواهد از من دفاع کند؛ می‌خواهد از بی‌بی و افراد مختلف دیگری دفاع کند.  
...
>  
>  
> مارکو روبیو: من در واقع فکر می‌کنم کسانی که در نظام ما بیش از همه در معرض خطرند، نظامیان و نیروهای یونیفرم‌پوش هستند. ممکن است تا پایان عمرشان تعقیب شوند و نتوانند همراه خانواده‌شان به هیچ جای جهان سفر کنند، چون ممکن است بر اساس یکی از این احکام بازداشت شوند.  
> تصور کنید سربازی هستید، در جنگی شرکت کرده‌اید و ۲۰ سال بعد می‌آیند شما را دستگیر کنند. این مشکل بزرگی است.  
>  
>  
>  
