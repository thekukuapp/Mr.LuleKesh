...
**آخرین بروزرسانی:** `2026-07-22 03:40:07` (به وقت ایران)
...
> من حتی نمی‌رسم بازشون کنم فقط از پیش‌نمایش دارم آخرین پیام هر کسی رو می‌بینم.  
>  
> پیام‌ها رسیده به مرکز شهر و حتی مناطقی در غرب تهران  
>  
> گرچه همیشه هستند کسانی که هر صدایی رو به برخورد تعبیر کنند ولی از غالب حجم پیام‌ها واضحه که صدای پدافند شنیده میشه در مناطق مختلف تهران  
>  
> آپدیت: ساعت ۸:۱۰  
> تا الان به طور پیوسته در هر ثانیه کلی پیام میومد. الان داره به حدود یک پیام در ثانیه کاهش پیدا می‌کنه.  
> همچنان صدای پدافند در همه مناطق تهران  
> 📡 @VahidOnline  
