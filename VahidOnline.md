...
**آخرین بروزرسانی:** `2026-06-11 21:40:24` (به وقت ایران)

---

### 🕒 2026-06-11 | 21:31:50 IRST

> اکسیوس به نقل از سه منبع آگاه گزارش داد شکاف‌های اصلی در جریان گفت‌وگو میان مقام‌های جمهوری اسلامی و میانجی‌های قطری روز چهارشنبه برطرف شده است  
>  
> اکسیوس: طرف‌های ایرانی و قطری چهارشنبه به این جمع‌بندی رسیدند که به متن مورد توافقی دست یافته‌اند که آمریکا نیز آن را می‌پذیرد  
>  
> اکسیوس: مقام‌های ایرانی پنج‌شنبه به چند کشور اعلام کرده‌اند مذاکرات تهران به توافقی اصولی منجر شده، اما مجتبی خامنه‌ای باید تایید نهایی را صادر کند  
> IranIntlbrk  
> انتخاب:‌ ادعای نیویورک پست  
> ایران پیش‌نویس یک توافقنامه را از طریق میانجی‌های قطری به ایالات متحده ارائه کرده است.  
> منابع می‌گویند این متن نهایی‌سازی و برای بررسی به واشنگتن ارسال شده است.  
> یک منبع آمریکایی دریافت این پیش‌نویس را تأیید کرده است، هرچند جزئیاتی فاش نشده است.  
>  
> ☄️ ترامپ به نیویورک پست، ادعا کرد که توافق با ایران «تقریباً کاملاً نهایی شده است»،/انتخاب  
>  
> 📡 @VahidOnline  
